      ...
      <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php
              ...
              echo form_open('Admin/editTeacher');
            ?>
      			<div class="box-body" name = "teacherInfo" id = "teacherInfo" data-url="<?=base_url();?>">
      				<div class="row clearfix">
                <div class="col-md-12">
        					<div class="col-md-4">
        						<label for="id" class="control-label"><span class="text-danger">*</span>Teacher ID #:</label>
                  ...
                  <div class="col-md-3" style = "display: flex; align-items: center; justify-content: center; height: 11%">
                    <button type="button" class="btn btn-default" onclick = "editTeacher()">
                ...
                name = "deactivateBtn" onclick = "deactivateTeacher()" disabled>
